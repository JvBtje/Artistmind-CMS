...
if ($type == "select"){
	...
	while($rowc12 = mysqli_fetch_array($resultc12)){		
		...
		$output .= '<div id="bar"><div id="bar'.$MainIdGroupc12.'" ><script>if (window.thebars == null || window.thebars == undefined){window.thebars=Array();}window.thebars.push("bar'.$MainIdGroupc12.'")</script>';
